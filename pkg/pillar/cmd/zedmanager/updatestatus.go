...
func doUpdate(ctx *zedmanagerContext,
	...
	// Manage events necessitating VM shutdown (such as snapshot removal, rollback) following our manual adjustment of
	// the VM's status to RESTARTING. This is different from instances where the VM is deactivated due to a purge&update
