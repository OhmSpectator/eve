...
pthread_t run_psi_monitor(config_t *config, fds_to_close_t *fds_to_close) {
...
int monitor_start(config_t *config, resources_to_cleanup_t *resources_to_cleanup)
{
    ...
    pthread_t psi_monitor_thread = run_psi_monitor(config, &resources_to_cleanup->fds_to_close);
